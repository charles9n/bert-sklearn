...
sys.path.append(".")
from bert_sklearn.model.pytorch_pretrained.file_utils import WEIGHTS_NAME, CONFIG_NAME
from bert_sklearn.model.pytorch_pretrained.modeling import BertForSequenceClassification
from bert_sklearn.model.pytorch_pretrained.tokenization import BertTokenizer
from bert_sklearn.model.pytorch_pretrained.optimization import BertAdam, WarmupLinearSchedule
...
def main():
    ...
    parser.add_argument("--bert_model", default=None, type=str, required=True,
                        ...
                        "bert-base-multilingual-cased, bert-base-chinese, bert-base-portuguese-cased, bert-large-portuguese-cased")
